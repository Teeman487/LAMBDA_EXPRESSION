package Lambda_Expression_FunctionalInterface;

@FunctionalInterface  // Its optional but for explicity // Lambda Expressions are always asscociated with Functional Interface
// Functional interface(that allows one abstract method) only allows Lambda Expression; but other type of interfaces dont allow
